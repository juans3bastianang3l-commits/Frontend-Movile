...
const SolicitudesScreen = ({ setScreen }) => {
    ...
    const loadProducts = async () => {
        try {
            ...
            const soloSolicitudes = (data.datos || [])

            setProducts(soloSolicitudes);
        } catch (error) {
    ...
    if (rol == 'administrador'){
        return (
            <View style={styles.container}>
                ...
                <Button style={styles.button} title="Mis Datos de Usuario" onPress={() => setScreen("user")}/>
                <Button color="purple" style={styles.button} title="Ver los Productos" onPress={() => setScreen("products")}/>
                        ...
                        <View style={styles.card}>
                            {editingProduct === item.id ? (
                                ...
                                <>
                                    ...
                                    <Text style={styles.description}>Producto id: {item.producto_id}</Text>
                                    <Text style={styles.description}>Id de Usuario que ordeno: {item.usuario_id}</Text>
                                </>
                            )}
                        </View>
                    )}
                        ...
                        <View style={styles.card}>
                            {editingProduct === item.id ? (
                                ...
                                <>
                                    <Text style={styles.title}>{item.titulo}</Text>
                                    <Text style={styles.description}>{item.descripcion}</Text>
                                    <Text style={styles.description}>Solicitud pendiente...</Text>
                                </>
                            )}
                        </View>
                    )}
